                ...
                try
                {
                    ...
                    if (!context.ContactOrganizations.Any())
                    {
                        context.ContactOrganizations.AddRange(
                            ...
                            new ContactOrganization { ContactID = 23, OrganizationID = 46 },

                            new ContactOrganization { ContactID = 24, OrganizationID = 47 },
                            new ContactOrganization { ContactID = 24, OrganizationID = 48 },

                            new ContactOrganization { ContactID = 25, OrganizationID = 49 },
                            new ContactOrganization { ContactID = 25, OrganizationID = 50 }
                        );
                        context.SaveChanges();
                    }
